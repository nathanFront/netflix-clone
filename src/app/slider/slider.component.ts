...
export class SliderComponent implements OnInit {
  ...
  constructor(private elementRef:ElementRef, private getMovies:MoviesService) {}
  ...
  ngOnInit(){
    ...
    this.slideData.forEach( item => {
      this.getMovies.getMovieSeries(item).subscribe( result => this.movieList.push(result))
    })
